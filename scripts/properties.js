var PropertyChange = (function () {
    ...
    PropertyChange.prototype.mindMapPropertyChange = function (args) {
        if (diagram && diagram.nodes.length > 0) {
            var nodes = levelType === "Selected Item" ? diagram.selectedItems.nodes : diagram.nodes;
    ...
    PropertyChange.prototype.updateMindMapTextStyle = function (node, propertyName) {
    ...
    PropertyChange.prototype.drawShapeChange = function (node, args) {
